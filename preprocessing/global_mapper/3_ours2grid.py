...
def generate_datasets(idx, data_type):
    with open(f'C:/Users/Dobby/Downloads/graph_condition_city_datasets/eu_ours_city_datasets/graph_condition_train_datasets/{data_type}/{str(idx)}.pkl', 'rb') as file:
        buildings = pickle.load(file)

    graph = nx.read_gpickle(f'C:/Users/Dobby/Downloads/graph_condition_city_datasets/eu_ours_city_datasets/graph_condition_train_datasets/{data_type}/{str(idx)}.gpickle')
    ...
    if is_test_save:
        ...
        output_file_path = f'eu_global_mapper_datasets/{data_type}'
