...
if __name__ == '__main__':
    end_index = 208622 + 1
    data_type = 'test'
    indices = [1004, 1012, 1003, 109, 105, 1063, 1065, 1067, 1071, 1072, 1078, 1111, 10002, 1109, 10018,
               10013, 10073, 10077, 10080, 10073, 10196, 10207, 10211, 10212, 10273, 10270, 10291, 10292,
               10297, 10301, 10332, 10320, 10399, 10441, 10483, 10698, 10765, 10792, 10835, 10843, 10841]

    graphs = [create_line_graph(6), create_line_graph(10), create_line_graph(16), create_line_graph(20),
              create_ring_graph(6), create_ring_graph(10), create_ring_graph(16), create_ring_graph(20),
              create_grid_graph(2, 6), create_grid_graph(3, 4), create_grid_graph(4, 5), create_grid_graph(6, 2),
              create_random_graph(5, 0.5), create_random_graph(10, 0.4), create_random_graph(15, 0.3), create_random_graph(20, 0.2)]

    graph_types = ['line', 'line', 'line', 'line',
                  'ring', 'ring', 'ring', 'ring',
                  'grid', 'grid', 'grid', 'grid',
    ...
    for idx in indices:
        for building_edge, graph_type in zip(graphs, graph_types):
            ...
            building_adj_matrix = edges_to_adj_matrix(building_edge)
            ...
            nx.draw(G_visualized, with_labels=True, node_color='skyblue', node_size=700, edge_color='k')
