...
class GraphDataset(Dataset):
    ...
    def get(self, idx):
        ...
        if self.data_type == 'train' or self.data_type == 'val':
            ...
            #     pooled_node_features[i + pooled_boundary_n, 0] += node_features[i + boundary_n, 0]
            #     pooled_node_features[i + pooled_boundary_n, 1] += node_features[i + boundary_n, 1]
            #     pooled_node_features[i + pooled_boundary_n, 2] += node_features[i + boundary_n, 2]
            #     pooled_node_features[i + pooled_boundary_n, 3] += node_features[i + boundary_n, 3]
            #     pooled_node_features[i + pooled_boundary_n, 4] += node_features[i + boundary_n, 4]
            #
            ...
            for i in range(building_n):
                if unpooled_boundary_n > 200:
                    ...
                    x = unpooled_boundary_n
                unpooled_node_features[i + x, 0] += node_features[i + boundary_n, 0]
                unpooled_node_features[i + x, 1] += node_features[i + boundary_n, 1]
                unpooled_node_features[i + x, 2] += node_features[i + boundary_n, 2]
                unpooled_node_features[i + x, 3] += node_features[i + boundary_n, 3]
                unpooled_node_features[i + x, 4] += node_features[i + boundary_n, 4]
