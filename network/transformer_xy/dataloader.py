...
class BoundaryDataset(Dataset):
    ...
    def load_full_dataset(cls):
        ...
        if cls.full_dataset is None:
            ...
            for city_name in tqdm(city_names):
                ...
                all_building_cp_sequences.append(data['building_cp_sequences'])
            ...
            cls.full_dataset = {
                ...
                'building_cp_sequences': np.concatenate(all_building_cp_sequences, axis=0),
    ...
    def __init__(self, train_ratio=0.8, val_ratio=0.1, test_ratio=0.1, data_type='train', load=True):
        ...
        self.building_cp_sequences = self.full_dataset['building_cp_sequences'][self.start_index:self.end_index]
        ...
        print('building_cp_sequences shape: ', self.building_cp_sequences.shape)
    ...
    def __getitem__(self, index):
        ...
        building_cp_sequence = self.building_cp_sequences[index]
        street_index_sequence = self.street_index_sequences[index]
        unit_coords_dataset = self.unit_coords_datasets[index]

        return unit_position_dataset, street_position_dataset, building_cp_sequence, street_index_sequence, \
               unit_coords_dataset
