...
class GraphDataset(Dataset):
    ...
    @classmethod
    def load_full_dataset(cls, n_street, n_building, n_boundary, d_unit, d_street):
    ...
    def __init__(self, train_ratio=0.8, val_ratio=0.1, test_ratio=0.1, data_type='train', load=True,
                 n_street=50, n_building=120, n_boundary=200, d_unit=8, d_street=64):
        ...
        if self.full_dataset is None:
            if load:
                self.load_full_dataset(n_street, n_building, n_boundary, d_unit, d_street)
