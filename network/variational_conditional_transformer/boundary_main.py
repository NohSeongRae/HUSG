...
class Trainer:
    def __init__(self, batch_size, max_epoch, pad_idx, d_street, d_unit, d_model, n_layer, n_head,
        ...
        self.train_dataset = BoundaryDataset(n_boundary=n_boundary, d_street=d_street, data_type='train')
        ...
        self.val_dataset = BoundaryDataset(n_boundary=n_boundary, d_street=d_street, data_type='val')
