...
def preprocesing_dataset(train_ratio=0.8, val_ratio=0.1, test_ratio=0.1,
    ...
    for data_type in ['train', 'val', 'test']:
        ...
        save_path = './network/variational_conditional_transformer/' + data_type + '_boundary_datasets'
        ...
        np.savez(save_path,
                 ...
                 gt_unit_position_datasets=full_dataset['gt_unit_position_datasets'][start_index:end_index]
                 )
