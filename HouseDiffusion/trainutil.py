...
class TrainLoop:
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            micro_cond={
                k: v[i : i + self.microbatch].to(dist_util.dev()) for k,v in cond.item()
            }
            ...
            log_loss_dict(
                self.diffusion, t, {k: v* weights for k,v in losses.item()}
            )
...
def parse_resume_step_from_filename(filename):
    """
    Parse filenames of the form path/to/modelNNNNNN.pt, where NNNNNNIs the checkpoint's number of steps.
    :param filename:
    :return:
    """
...
def find_resume_checkpoint():
    """
    On your infrastructure, you may want to override this to automatically discover the latest checkpoint
    on your blob storate, etc.
    :return:
    """
    return None
