...
class GraphDecoder(nn.Module):
    ...
    def forward(self, z, edge_index, batch):
        ...
        output_pos = torch.tanh(self.fc_pos(output_pos))
...
class GraphCVAE(nn.Module):
    ...
    def forward(self, data):
        ...
        output_pos, output_size = self.decoder(z, edge_index, data.batch)
    ...
    def test(self, data):
        ...
        output_pos, output_size = self.decoder(z, data.edge_index, data.batch)
