...
def test(d_feature, d_latent, n_head, T, checkpoint_epoch, save_dir_path, condition_type, convlayer):
    ...
    with torch.no_grad():
        ...
        for data in tqdm(test_dataloader):
            ...
            import pickle
            load_path = f'/local_datasets/urban_datasets/eu_blockplanner_datasets/test/{graph_file[0]}'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--convlayer", type=str, default='gcn', help="save dir path")
