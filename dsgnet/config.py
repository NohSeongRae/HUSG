...
def add_data_args(parser):
    ...
    parser.add_argument('--train_dataset', type=str, default='test.txt', help='file name for the list of object names for training')
...
def add_train_vae_args(parser):
    ...
    parser.add_argument('--geo_feat_size', type=int, default=128)
    parser.add_argument('--feature_size', type=int, default=128)
    parser.add_argument('--hidden_size', type=int, default=128)
    parser.add_argument('--num_point', type=int, default=5402)
    ...
    parser.add_argument('--lr_decay_every', type=float, default=4000)
    ...
    parser.add_argument('--loss_weight_box', type=float, default=30.0, help='weight for the box reconstruction loss')
    ...
    parser.add_argument('--part_pc_exp_name', type=str, default='', help='resume model exp name')
    parser.add_argument('--part_pc_model_epoch', type=int, default=0, help='resume model epoch')
